"""
Django settings for python_DNA project.
...
SECRET_KEY = 'django-insecure-zc79zn_$@9w$b!-fwi%6b(ss8wkhfz*_+*ti%ku&u7z5^h!f-n'
...
WSGI_APPLICATION = 'python_DNA.wsgi.application'
